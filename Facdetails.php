...
<html>
    ...
    <body>
        <?php
            ...
            $sql2="SELECT * FROM `login_table` WHERE userid = '$id'";
                            ...
                            <div class="col-lg-4">
                                <div class="card shadow-sm">
                                    <div class="card-header-1 bg-transparent text-center">
                                        <img class="profileimage" src="./profile_images/<?php echo $rows['facultyimage'];?>" alt="student dp">
                                    </div>
                                    <div class="card-body">
                                        Name:<h3><?php echo $rows['facultyname'];?></h3>
                                        <p class="mb-0"><strong class="pr-1">Faculty ID:</strong><?php echo $rows['facultyid'];?></p>
                                        <p class="mb-0"><strong class="pr-1">Class:</strong><?php echo $rows['facultyclass'];?></p>
                                        <p class="mb-0"><strong class="pr-1">Designation:</strong><?php echo $rows['facultydesig'];?></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="2%">:</td>
                                            <td><?php echo $rows['facultybname'];?></td>
                                        </tr>
                                        <tr>
                                            <th width="30%">Gender</th>
                                            <td width="2%">:</td>
                                            <td><?php echo $rows['facultygender'];?></td>
                                        </tr>
                                        <tr>
                                            <th width="30%">House Name</th>
                                            <td width="2%">:</td>
                                            <td><?php echo $rows['facultyhname'];?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="2%">:</td>
                                            <td><?php echo $rows2['useremail'];?></td>
                                        </tr>
                                        <tr>
                                            <th width="30%">Date of Birth</th>
                                            <td width="2%">:</td>
                                            <td><?php echo $rows['facultydob'];?></td>
                                        </tr>
                                        </table>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body pt-0">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td width="2%">:</td>
                                                    <td><?php echo $rows['facultyqualif'];?></td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">Current Job</th>
                                                    <td width="2%">:</td>
                                                    <td><?php echo $rows['facultyjob'];?></td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">Father's Name</th>
                                                    <td width="2%">:</td>
                                                    <td><?php echo $rows['facultyfather'];?></td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">Mother's Name</th>
                                                    <td width="2%">:</td>
                                                    <td><?php echo $rows['facultymother'];?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
