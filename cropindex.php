					...
					<div class="image_area">
						<form method="post">
							<label for="upload_image">
								<img src="profile_images/<?php echo $rst['studentimage'];?>" id="uploaded_image">
								<div class="overlay">
			  	...
			  	<div class="modal-dialog modal-lg" role="document">
			    	<div class="modal-content">
			      		...
			      		<div class="modal-footer">
			      			<button type="button" id="crop" class="btn btn-primary">Set as Profile Image</button>
			...
			reader.onloadend = function(){
				...
				$.ajax({
					...
					success:function(data)
					{
						...
						window.location.href = "studentimage.php";
					}
				});
			};
		});
