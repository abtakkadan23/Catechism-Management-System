        ...
        <section class="main">
            ...
            <div class="topbar" style="display:block;">
                <span class="topbar--item">
                    <a href="attendview.php" style="margin-right: 20px;">
                ...
                <span class="topbar--item">
                    <a href="facattendview.php" style="margin-right: 20px;" id="active--link">
                        <i class="ri-line-chart-line"></i>
                        View Faculties'
                    </a>
                </span>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select type="text" name="d" id="d" onChange="get_date(this.value);">
                                        <option value="">Select a date</option>
                                        <?php
                                            $q2 = mysqli_query($con, "SELECT DISTINCT at_date FROM tbl_attend");
                                            ...
                                            if (mysqli_num_rows($q2) > 0) 
                                            {
                                                ...
                                                {
                                        ?>
                                                <option value="<?php echo $row['at_date'];?>"><?php echo $row['at_date'];?></option>;
                                        <?php
                                                }
                                            }
                                        ?>
