<?php
    ...
    $ssql = "SELECT studid, s_atdate, s_status, adminregisterstudent.studentname FROM tbl_studatt JOIN adminregisterstudent ON tbl_studatt.studid = adminregisterstudent.studentid AND tbl_studatt.class = adminregisterstudent.studentclass AND s_atdate='$option'";
