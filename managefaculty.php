    ...
    <section class="main">
        ...
        <div class="topbar" style="display:block;">
            <span class="topbar--item">
                <a href="managefaculty.php" style="margin-right: 20px;" id="active--link">
        ...
        <div class="main--content">
            <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title"> <b>Faculty Details</b> </h2>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        ROW OF EVERY COLUMN -->
                                        <td><img class="avatar" style="height: 60px; width:60px;" src="./profile_images/<?php echo $rows['facultyimage'];?>" alt="student dp"></td>
                                        <td><?php echo $rows['facultyid'];?></td>
                                        <td><?php echo $rows['facultyname'];?></td>
                                        <td><?php echo $rows['facultyclass'];?></td>
                                        <td><center><a href="updatefaculty.php?id=<?php echo $rows['facultyid'];?>"><button style="color: White; background-color:orange; width:80px; height:30px;"><i class="ri-edit-line"></i>Edit</button></a></center></td>
                                        <td><center><a href="Facdetails.php?id=<?php echo $rows['facultyid'];?>"><button style="color: White; background-color:orange; width:120px; height:30px;"><i class="ri-edit-line"></i>View Profile</button></a></center></td>
                                    </tr>
                            <?php
                                }
                            ?>
