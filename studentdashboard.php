                    ...
                    <div class="picon chat">
                        <span>
                            <?php
                                ...
                                $id = $rows['userid'];
                                $sqli = "select * from adminregisterstudent where studentid = '$id'";
                                $rx = mysqli_query($con, $sqli);
                                $rst = $rx->fetch_assoc();
                                echo $rst['studentname'];
                            ?>
                        </span>
    ...
    <section class="main">
            ...
            <ul class="sidebar--items">
                <li>
                    <a href="facultydashboard.php" id="active--link">
                        ...
                        <span class="sidebar--item"> Student Dashboard</span>
                    </a>
                </li>
        ...
        <div class="main--content">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                ...
                                <?php 
                                    ...
                                    $fid = $fg['userid'];
                                    $result = "select * from adminregisterstudent where studentid = '$fid'";
                                    $res = $con->query($result);
                                    $xx = $res->fetch_assoc();
                                    $cd = $xx['studentclass'];
                                    $result = "select * from assoclass where assoc_id = '$cd'";
                                    $res = $con->query($result);
                                    $xx = $res->fetch_assoc();
                                    $c = $xx['class_id'];
                                    $d = $xx['div_id'];
                    ...
                    <div class="card card-2">
                        <div class="card--data">
                            <div class="card--content">
                                ...
                                <h1>
                                    <?php 
                                        $cal1="SELECT COUNT(studentid) FROM adminregisterstudent WHERE studentclass='$cd' AND status=1";
                                        $cal2 = $con->query($cal1);
            ...
            <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title"><b>Classmates</b></h2>
                    ...
                    <table>
                        ...
                        <tbody> 
                            <?php
                                ...
                                $sql1="SELECT * FROM `adminregisterstudent` where studentclass = '$cd' and status = 1 order by studentname";
